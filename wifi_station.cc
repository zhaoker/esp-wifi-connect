...
void WifiStation::Start()
{
    ...
    if (netif) {
        ESP_LOGW(TAG, "esp_netif already exists. Skipping creation...");
    } else {
...
{
    auto bits = xEventGroupWaitBits(event_group_, WIFI_EVENT_CONNECTED | WIFI_FAIL_BIT, pdFALSE, pdFALSE, timeout_ms / portTICK_PERIOD_MS);
